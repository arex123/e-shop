...
const About = () => {
  return (
    <div className="flex flex-col items-center">
      <h2 className="my-10 text-4xl font-bold">About</h2>
      <div className="flex w-[60%]">
        <img className="rounded-full h-52 mr-10" src="https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png" />
        <p>
          ...
          the needs of the agony of the choice. We hate the fellow.<br/> Lorem ipsum
